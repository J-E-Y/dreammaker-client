        ...
        <div className="c-container">
          ...
          {/* <div id={`q${count}-area`} style={{ display: display }}> */}
            ...
            <center>
              ...
              <button onClick={this.yesBTN} type='submit'>네</button>

              <button onClick={this.noBTN} type='submit'>아니오</button>

              <button onClick={this.bothBTN} type='submit'>잘 모르겠어요</button>
            </center>
          </div>
          {/* //? ------------질문1 끝----------------------- */}
          ...
          <div id='q2-area'style={{ display: otherDisplay }}>
            ...
            <h1 className="u-text-title">Q.박물관을 가거나, 전시회 관람하는 것을 좋아하시나요?</h1>
            <div className="row mt-10">
              <div className="col-sm-12">
                <div className="c-form-group">
                  <div className="c-form-group-label">
